...
#--output_file /data/home/scyb328/MuxServe-vLLM/MuxServe/examples/tp2_workload.json \
#--model_yaml /data/home/scyb328/MuxServe-vLLM/MuxServe/examples/basic/models.yaml \
#--request_per_second 0.25 \
#--alpha 0 \
#--trace_type muxserve
...
python -m muxserve.launch /data/home/scyb328/MuxServe-vLLM/MuxServe/examples/basic/tp2_config.yaml \
